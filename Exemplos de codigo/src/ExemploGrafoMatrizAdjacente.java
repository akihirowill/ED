...
public class ExemploGrafoMatrizAdjacente {
    private final int MAX_NO_OF_VERTICES;
    private int adjacency_matrix[][];

    public ExemploGrafoMatrizAdjacente(int number_of_vertices)
    {
    ...
    public static void main(String... arg)
    {
        ...
        ExemploGrafoMatrizAdjacente adjacencyMatrix;
        ...
        try
        {
            ...
            adjacencyMatrix  = new ExemploGrafoMatrizAdjacente(number_of_vertices);
